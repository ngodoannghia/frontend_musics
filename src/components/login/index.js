...
function Login(props) {
  ...
  return ( <div className="hold-transition login-page" style={{"textAlign":"center",position:"fixed",top:0,left:0,width:"100%",height:"100%"}} >
     <div style={{"textAlign":"center"}}> 
     <img style = {{width:"100%", objectFit: "cover" , maxWidth:"600px"}} src="banner.jpg" ></img>
     </div>
